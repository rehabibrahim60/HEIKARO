...
const estimateReadTime = (text = "") => {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        {/* Soft Blue Glow */}
        <div className="absolute left-10 top-1/2 -translate-y-1/2 w-72 h-72 bg-blue-600/20 blur-[120px] rounded-full"></div>
        ...
        <h1 className="text-[150px] md:text-[280px] lg:text-[600px] leading-[0.68] font-black tracking-tight text-blue-600 drop-shadow-[0_0_40px_rgba(37,99,235,0.75)]">
            THE
            <br />
            JOURNAL
        </h1>
            ...
            <button
              ...
              className={`px-6 py-3 text-[13px] font-black tracking-[0.18em] uppercase transition-all border ${
                selectedCategory === cat
                  ...
                  : "bg-[#151515] text-gray-400 border-[#242424] hover:text-white hover:border-blue-600"
              }`}
            >
              {cat}
            </button>
        ...
        {blogs.map((blog) => (
          ...
          >
            ...
            <div className="p-8">
              ...
              {/* Title */}
              <h2 className="text-white text-2xl md:text-[28px] leading-[1.05] font-black uppercase mb-6 group-hover:text-blue-500 transition-colors">
                {blog.title}
              </h2>
              ...
              <div className="mt-10 pt-6 border-t border-white/10 flex items-center justify-between">
                ...
                <span className="text-blue-600 text-2xl group-hover:translate-x-2 transition-transform">
                  →
                </span>
              </div>
            </div>
