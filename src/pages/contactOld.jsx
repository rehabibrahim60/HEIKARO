...
import "./style/about.css"; // Make sure this line exists at the top of the file
const Contact = () => {
  return (
      ...
      <section className="contact-hero">
        ...
        <div className="contact-container">
          ...
          <svg viewBox="0 0 600 250" className="gradient-svg">
            {" "}
            <text x="0" y="80" className="text-content">
              CONNECT
            </text>{" "}
            <text x="0" y="170" className="text-content">
              & CONVERT.
            </text>{" "}
          </svg>{" "}
          <p className="contact-subtitle">
            {" "}
            — Connect with HEIKARO to shape the next iteration of your
            brand.{" "}
          </p>{" "}
        </div>{" "}
      </section>{" "}
        ...
        <div className="form-column">
          ...
          <form className="main-form">
            ...
            <div className="field">
              ...
              <input
                type="text"
                placeholder="Please select a service family first"
              />{" "}
            </div>{" "}
            <div className="field">
              {" "}
        ...
        <aside className="sidebar-column">
          ...
          <div className="strategic-box">
            ...
            <ul className="tracks-list">
              {" "}
              <li>BRAND & IDENTITY</li> <li>DESIGN & EXPERIENCE</li>{" "}
              <li>CONTENT & STORYTELLING</li> <li>MARKETING & GROWTH</li>{" "}
            </ul>{" "}
