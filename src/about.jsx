...
const strategicData = [
  ...
  },
  {
    ...
    heikaro: "A campaign idea, content architecture, media direction, and performance logic"
  },
  {
    id: "003",
    typical: "A website screen",
    heikaro: "A digital experience with message hierarchy, UX flow, SEO structure, and conversion intent"
  },
  {
    id: "004",
    typical: "A video",
    heikaro: "A story-driven media asset connected to brand perception and audience behavior"
  },
  {
    id: "005",
    typical: "Random AI experiments",
    heikaro: "AI-powered workflows connected to real business and creative outcomes"
  }
];

const ecosystemData = [
  { title: "STRATEGY COMMAND", desc: "Brand strategy workshop boards linking business goals with visual direction.", img: "https://images.unsplash.com/photo-1531403009284-440f080d1e12?auto=format&fit=crop&w=500&q=80" },
  { title: "DYNAMIC IDENTITY SHEETS", desc: "Complete visual identity frameworks & responsive grid elements.", img: "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?auto=format&fit=crop&w=500&q=80" },
  { title: "STORYTELLING STUDIO", desc: "High-end narrative captured using cinematic lighting and high-definition gear.", img: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?auto=format&fit=crop&w=500&q=80" },
  { title: "PERFORMANCE INTEL", desc: "Real-time campaign analytics tracing conversions, traffic, and user actions.", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=500&q=80" },
  { title: "DIGITAL JOURNEY MAP", desc: "Highly tailored user interfaces designed to streamline conversion funnels.", img: "https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=500&q=80" },
  { title: "GENERATIVE ENGINE", desc: "Cinematic, AI-enhanced workflow blending live frames and CGI pipelines.", img: "https://images.unsplash.com/photo-1614741118887-7a4ee193a5fa?auto=format&fit=crop&w=500&q=80" },
  { title: "EXPERIENTIAL SPACE", desc: "Bespoke events, booths, and physical product launch configurations.", img: "https://images.unsplash.com/photo-1511578314322-379afb476865?auto=format&fit=crop&w=500&q=80" },
  { title: "CREATIVE GRID", desc: "Connecting strategy, design, production, and AI-accelerated frameworks.", img: "https://images.unsplash.com/photo-1508921912186-1d1a45ebb3c1?auto=format&fit=crop&w=500&q=80" }
];

const beliefsData = [
  { id: "BELIEF 01", category: "PERSISTENT LOGIC", title: "STRATEGY DRIVES CREATIVITY", desc: "We believe that pure aesthetics without a core business logic are meaningless. Every pixel must serve a strategic intent." },
  { id: "BELIEF 02", category: "PERSISTENT LOGIC", title: "SYSTEMIC THINKING", desc: "We don't build isolated assets. We craft connected digital ecosystems where design, media, and tech reinforce each other." },
  { id: "BELIEF 03", category: "PERSISTENT LOGIC", title: "HUMAN REALISM", desc: "Even in a world governed by fast data, brand value is built on raw human emotions and authentic storytelling." },
  { id: "BELIEF 04", category: "PERSISTENT LOGIC", title: "AI EXPANDS THE CREATIVE ENGINE", desc: "We use AI as an accelerator for research, ideation, content systems and smarter execution without removing human judgment." }
];

const valueArchitectureData = [
  { id: "01", title: "CLARITY", desc: "To understand what their brand should stand for, how it should communicate, and how it should appear across every touchpoint." },
  { id: "02", title: "CONSISTENCY", desc: "To stop scattered visuals, weak content, and disconnected marketing efforts from weakening brand perception." },
  { id: "03", title: "GROWTH", desc: "To create campaigns, content, platforms, and experiences that support awareness, engagement, trust, and conversion." },
  { id: "04", title: "EXECUTION", desc: "To move from ideas to real deliverables with clear structure, timelines, files, outputs, and review logic." },
  { id: "05", title: "INNOVATION", desc: "To use AI, digital tools, visual systems, and modern production methods in ways that serve actual business goals." }
];
    ...
    <>
          ...
          <div className="ab-right">
            ...
            <div className="ab-card ab-card-1">
              ...
              <div className="ab-card-img-box">
                <img src="/laptop-design.jpeg" alt="Brand System Grid" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              </div>
              <div className="ab-card-meta">CONFIG_A_24</div>
            </div>
            ...
            <div className="ab-card ab-card-2">
              ...
              <div className="ab-card-center-text">
                <h3 className="ab-card-sub">[MOTION ST_03]</h3>
                <p className="ab-card-desc">CINEMATIC CAMERA SETUP. HYPER-FOCUSED EDITING LAYOUTS</p>
              </div>
              <div className="ab-card-meta">CONFIG MODEL_C_24</div>
            </div>
            ...
            <div className="ab-card ab-card-3">
              ...
              <div className="ab-card-img-box">
                <img src="/sketch-design.jpeg" alt="Interface Layout" onError={(e) => { e.currentTarget.style.display = 'none'; }} />
              </div>
              <div className="ab-card-meta">CONFIG MODEL_B_24</div>
            </div>
      ...
      <section className="services-root">
        <div className="services-header">
          ...
          <p className="services-sub">
            HEIKARO brings together multiple creative and strategic disciplines under one operating model.
          </p>
        </div>
      ...
      <section className="model-root">
        <div className="model-header">
          ...
          <p className="model-sub">
            Our work is structured to move from clarity to execution. Every project follows a disciplined creative process that keeps strategy, design, content, and delivery aligned.
          </p>
        </div>
      ...
      <section className="edge-root">
        <div className="edge-header">
          ...
          <p className="edge-sub">
            Many creative teams deliver outputs. HEIKARO is designed to build connected creative systems.
          </p>
        </div>
      ...
      <section className="eco-root">
        <div className="eco-header">
          ...
          <p className="eco-sub">Our work lives at the intersection of strategy, identity, content, technology, media, and experience.</p>
        </div>
      ...
      <section className="pers-root">
        <div className="pers-header">
          ...
          <p className="pers-sub">
            HEIKARO is built to feel strategic, cinematic, intelligent, disciplined, and bold.
          </p>
        </div>
