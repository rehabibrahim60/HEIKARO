            ...
            <section className="relative w-full overflow-hidden py-20 md:py-28">
                ...
                <div className="relative z-10 px-[6%] max-w-[1400px] flex flex-col lg:flex-row gap-16 lg:gap-20 items-start">
                    ...
                    <div className="lg:w-[260px] shrink-0">
                        {/* Icon box */}
                        <div className="w-11 h-11 border border-[#0f33fe] flex items-center justify-center mb-5">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0f33fe" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <p className="text-[#0f33fe] text-[10.5px] font-bold tracking-[0.22em] uppercase mb-4">
                            FAQs
                        </p>
                    ...
                    <div className="flex-1 w-full">
                        {faqs.map((faq, i) => {
                            ...
                            return (
                                <div
                                    key={i}
                                    className={`border mb-2 overflow-hidden transition-colors duration-200 ${
                                        isOpen ? "border-[#252a3e]" : "border-[#1a1e2e]"
                                    }`}
                                >
                                    <button
                                        onClick={() => toggle(i)}
