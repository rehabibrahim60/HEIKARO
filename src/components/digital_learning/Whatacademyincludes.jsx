        ...
        <section className="w-full bg-[#0d0d0d] px-[6%] py-24">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
                ...
                <div className="flex flex-col justify-center gap-6">
                    ...
                    >
                        What A Complete Academy Includes
                    </h2>
                    <p className="max-w-sm text-sm leading-relaxed text-[#666666]">
                        ...
                        elements to perform synchronously. A complete system aligns strategy,
                        usability, conversion, structure, and code.
                    </p>
                </div>

                {/* ── Right: 3-col grid of items ── */}
