...
import { FaChevronDown, FaChevronUp } from "react-icons/fa";  // ← سهم أحسن
import "./Navbar.css";
import MegaMenu from "./MegaMenu";
import logo from "../src/assets/Logo.png";  // ← اللوجو
      ...
      <div className="nav-links">
        ...
        >
          <span className="nav-link services-trigger">
            SERVICES {showServices ? <FaChevronUp size={10} /> : <FaChevronDown size={10} />}
          </span>
        </div>
