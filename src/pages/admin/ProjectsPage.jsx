    ...
    openBuilder({
      ...
      onPublish: async (data) => {
        try {
          ...
          if (!createRes.ok) throw new Error(createResult.message || "Failed to create project");
          ...
          {projects.map(pr => (
            <div key={pr._id} style={{ ...listCard, flexDirection: "column", gap: 12, padding: 0, overflow: "hidden", alignItems: "stretch" }}>
              ...
              <div style={{ padding: "12px 16px 16px" }}>
                <p style={{ color: "#f1f5f9", fontWeight: 600, fontSize: 15, margin: "0 0 4px" }}>{pr.title}</p>
